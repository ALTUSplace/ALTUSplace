  ...
  const faqs = [
    {
      ...
      icon: Car,
      question: "كيف يمكنني حجز سيارة أو عقار عبر منصة ALTUSplace؟",
    ...
    },
    {
      ...
      answer: "نعم تماماً. تعتمد منصة ALTUSplace نظام ضمان مالي (Escrow) حيث تبقى أموال العربون في حساب الوسيط المعتمد حتى يتم تأكيد استلام السيارة أو العقار بحالة ممتازة من طرف الشريك."
    },
    {
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-8 md:mb-12">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">
            كل ما ترغب في معرفته حول خدمات ALTUSplace
          </h2>
