...
export function WhatsAppNotificationModal({ isOpen, onClose, bookingDetails }: WhatsAppNotificationModalProps) {
  ...
  const [message, setMessage] = useState(
    bookingDetails
      ? `مرحباً، تم تأكيد حجزك رقم ${bookingDetails.id} لـ ${bookingDetails.carName} بمبلغ ${bookingDetails.totalPrice} درهم عبر منصة ألتوس بليس. شكراً لثقتكم بكراؤنا وممتلكاتنا.`
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5 text-right">
              ...
              <textarea
                ...
                className="w-full bg-slate-900 dark:bg-[#1C1C1E] border border-slate-700 dark:border-[#48484D] rounded-xl p-3 text-xs text-white focus:outline-none focus:border-emerald-500 leading-relaxed resize-none"
              />
            </div>
