...
export function SecurePaymentModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" dir="rtl">
      <div className="bg-slate-950 dark:bg-[#111113] border border-slate-800 dark:border-[#2C2C2E] rounded-3xl max-w-lg w-full shadow-2xl text-slate-100 dark:text-[#F1F1F3] overflow-hidden">
        <div className="bg-gradient-to-l from-amber-500/10 to-slate-950 dark:to-[#111113] border-b border-slate-800 dark:border-[#2C2C2E] p-6">
              ...
              <div className="bg-purple-500/5 border border-purple-500/20 rounded-2xl p-5 space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['Himti', 'Jumia Pay', 'Barid Cash'].map((wallet) => (
                    <button key={wallet} className="p-4 rounded-xl border border-slate-700 dark:border-[#48484D] bg-slate-900 dark:bg-[#1C1C1E] hover:border-purple-500/50 transition-all text-center">
