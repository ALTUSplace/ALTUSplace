    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" dir="rtl">
      <div className="bg-slate-950 dark:bg-[#111113] border border-slate-800 dark:border-[#2C2C2E] rounded-3xl p-8 max-w-md w-full space-y-6 shadow-2xl text-slate-100 dark:text-[#F1F1F3]">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-2xl flex items-center justify-between">
          <span className="text-xs text-slate-300 dark:text-[#D6D6DB] font-semibold">المبلغ الإجمالي للدفع:</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5 text-right">
            ...
            <input
              ...
              className="w-full bg-slate-900 dark:bg-[#1C1C1E] border border-slate-700 dark:border-[#48484D] rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-amber-500 uppercase"
              required
            />
          </div>
          ...
          <div className="space-y-1.5 text-right">
            ...
            <input
              ...
              className="w-full bg-slate-900 dark:bg-[#1C1C1E] border border-slate-700 dark:border-[#48484D] rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-amber-500 font-mono tracking-widest"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5 text-right">
              ...
              <input
                ...
                className="w-full bg-slate-900 dark:bg-[#1C1C1E] border border-slate-700 dark:border-[#48484D] rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-amber-500 text-center font-mono"
                required
              />
            </div>
