 ...
 * showcase entries (approved apartments, …) are ALWAYS visible on the
 * homepage regardless of seeding or database availability. Cards deep-link to
        ...
        <div className="mt-auto space-y-2 pt-1">
          ...
          {property && (
            <p className="text-[11px] font-bold text-ink-tertiary">
              ...
              {!!item.area && item.area > 0 ? `${item.area} م² · ` : ""}
