    ...
    <div className="min-h-screen bg-slate-50 px-4 py-12" dir={isArabic ? "rtl" : "ltr"}>
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        <section className="grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm"><Car className="mb-3 h-6 w-6 text-accent-clay" /><h2 className="font-bold">{isArabic ? "بحث سريع" : language === "fr" ? "Recherche rapide" : "Fast search"}</h2><p className="mt-2 text-sm leading-6 text-muted-foreground">{isArabic ? "قارن السيارات والأسعار قبل التواصل مع الشريك." : language === "fr" ? "Comparez les véhicules et les prix avant de contacter le partenaire." : "Compare cars and prices before contacting the partner."}</p></div>
        </section>
