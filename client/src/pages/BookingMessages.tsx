      ...
      <div className="mx-auto max-w-3xl space-y-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-black text-[#15120D]">مراسلات الحجز #{bookingId}</h1>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader><CardTitle className="flex items-center gap-2 text-[#15120D]"><MessageCircle className="h-5 w-5 text-amber-600" /> المحادثة</CardTitle></CardHeader>
