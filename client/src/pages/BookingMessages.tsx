    ...
    <main dir={direction} className="min-h-screen bg-slate-50 px-4 py-8 sm:px-6">
      <div className="mx-auto max-w-3xl space-y-5">
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader><CardTitle className="flex items-center gap-2 text-[#1C1C1E]"><MessageCircle className="h-5 w-5 text-amber-600" /> المحادثة</CardTitle></CardHeader>
