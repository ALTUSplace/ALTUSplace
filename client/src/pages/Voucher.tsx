...
export default function VoucherPage() {
  ...
  return <section className="min-h-[70vh] bg-slate-50 px-4 py-8 sm:px-6">
    <div className="mx-auto max-w-5xl">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3"><div><p className="text-sm font-semibold uppercase tracking-[0.18em] text-amber-700">B2-Rent Morocco</p><h1 className="mt-1 text-3xl font-black text-[#0B0F15]">الوصول الذكي · Smart Access</h1></div><Badge className="bg-emerald-100 text-emerald-800 hover:bg-emerald-100"><CheckCircle2 className="mr-1 h-4 w-4" /> تذكرة صالحة</Badge></div>
