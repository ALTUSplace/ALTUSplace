  ...
  return <div className="container max-w-4xl space-y-6 py-6 md:py-10" dir="rtl">
    ...
    <form onSubmit={submit} className="space-y-6 rounded-3xl border bg-card p-5 shadow-sm md:p-7">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Field label="رقم الواتساب" value={form.whatsappNumber} onChange={(value) => updateField("whatsappNumber", value)} placeholder="06XXXXXXXX أو +2126XXXXXXXX" dir="ltr" inputMode="tel" hint="رقم الواتساب العمومي للتواصل المباشر مع زبنائك عبر wa.me — يظهر زر «تواصل عبر واتساب» للزبناء بعد تأكيد الحجز وفي صفحة «حجوزاتي». مثال: 06XXXXXXXX أو 2126XXXXXXXX." />
